...
(function(g){
g.Characters=[{id:'chiikawa',name:'吉伊',en:'CHIIKAWA',line:'虽然会紧张，也想再努力一次。',color:'#e8b1b3'},{id:'hachiware',name:'小八',en:'HACHIWARE',line:'没关系，总会有办法的！',color:'#a7c7dc'},{id:'usagi',name:'乌萨奇',en:'USAGI',line:'呀哈！今天也要大冒险！',color:'#e5ce8b'}];
...
g.Assets={images:{},async load(){
 const names=['meadow','chiikawa','hachiware','usagi','chiikawa-jump','hachiware-jump','usagi-jump','chimera','mushroom','weed','coin','guitar','platform'];
